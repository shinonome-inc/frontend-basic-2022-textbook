...
type PageQueryQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allFile: { readonly nodes: ReadonlyArray<Pick<File, 'name'>> } };
